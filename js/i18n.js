...
const KL_TRANSLATIONS = {
  fr: {
    ...
    downloadsVersion: 'Version officielle Windows - Build V90.8 du 05-09-2026',
    downloadsFile: 'Fichier : KaronlineBox_V90_8_Setup.exe (~75 Mo)',
  ...
  en: {
    ...
    downloadsVersion: 'Official Windows version - V90.8 build dated 05-09-2026',
    downloadsFile: 'File: KaronlineBox_V90_8_Setup.exe (~75 MB)',
