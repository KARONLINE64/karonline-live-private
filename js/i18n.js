...
const KL_TRANSLATIONS = {
  fr: {
    ...
    downloadsVersion: 'Version officielle Windows - Build V91.0 du 05-09-2026',
    downloadsFile: 'Fichier : KaronlineBox_V91_0_Setup.exe (~75 Mo)',
  ...
  en: {
    ...
    downloadsVersion: 'Official Windows version - V91.0 build dated 05-09-2026',
    downloadsFile: 'File: KaronlineBox_V91_0_Setup.exe (~75 MB)',
