...
const KL_TRANSLATIONS = {
  fr: {
    ...
    downloadsVersion: 'Version officielle Windows - Build V90.6 du 04-09-2026',
    downloadsFile: 'Fichier : KaronlineBox_V90_6_Setup.exe (~75 Mo)',
  ...
  en: {
    ...
    downloadsVersion: 'Official Windows version - V90.6 build dated 04-09-2026',
    downloadsFile: 'File: KaronlineBox_V90_6_Setup.exe (~75 MB)',
