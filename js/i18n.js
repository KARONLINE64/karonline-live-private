...
const KL_TRANSLATIONS = {
  fr: {
    ...
    downloadsVersion: 'Version officielle Windows - Build du 02-09-2026',
    downloadsFile: 'Fichier : KaronlineBox_Setup.zip (~75 Mo — ouvrez le ZIP puis lancez le setup)',
  ...
  en: {
    ...
    downloadsVersion: 'Official Windows version - Build dated 02-09-2026',
    downloadsFile: 'File: KaronlineBox_Setup.zip (~75 MB — open the ZIP then run the setup)',
